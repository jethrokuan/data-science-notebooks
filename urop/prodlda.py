"""From: https://github.com/akashgit/autoencoding_vi_for_topic_models"""
...
from urop.utils import xavier_init, log_dir_init
...
class ProdLDA(object):
    ...
    def __init__(self, network_architecture, transfer_fct=tf.nn.softplus,
        ...
        self.a = np.ones((1, self.h_dim)).astype(np.float32)
